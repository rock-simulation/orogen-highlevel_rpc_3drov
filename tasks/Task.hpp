...
#ifndef HIGHLEVEL_RPC_3DROV_TASK_TASK_HPP
#define HIGHLEVEL_RPC_3DROV_TASK_TASK_HPP


#include <VdalRpcIfClient.h>

#include "highlevel_rpc_3drov/TaskBase.hpp"
...
namespace highlevel_rpc_3drov {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','highlevel_rpc_3drov::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        VdalRpcIfClientNamespace::RpcIfClient *toto;
    ...
    public:
         ...
         */
        Task(std::string const& name = "highlevel_rpc_3drov::Task");
